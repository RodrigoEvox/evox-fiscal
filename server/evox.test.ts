...
vi.mock("./db", () => ({
  ...
  listChatChannels: vi.fn().mockResolvedValue([]),
  getChatChannel: vi.fn().mockResolvedValue(null),
  createChatChannel: vi.fn().mockResolvedValue(1),
  createChatNotification: vi.fn().mockResolvedValue(1),
  listUnreadNotifications: vi.fn().mockResolvedValue([]),
  countUnreadNotifications: vi.fn().mockResolvedValue([]),
  markNotificationsRead: vi.fn().mockResolvedValue(undefined),
  markAllNotificationsRead: vi.fn().mockResolvedValue(undefined),
  listColaboradores: vi.fn().mockResolvedValue([]),
  getColaboradorById: vi.fn().mockResolvedValue(null),
  createColaborador: vi.fn().mockResolvedValue(1),
  updateColaborador: vi.fn().mockResolvedValue(undefined),
  deleteColaborador: vi.fn().mockResolvedValue(undefined),
  listFerias: vi.fn().mockResolvedValue([]),
  getFeriasById: vi.fn().mockResolvedValue(null),
  createFerias: vi.fn().mockResolvedValue(1),
  updateFerias: vi.fn().mockResolvedValue(undefined),
  listSolicitacoesFolga: vi.fn().mockResolvedValue([]),
  createSolicitacaoFolga: vi.fn().mockResolvedValue(1),
  updateSolicitacaoFolga: vi.fn().mockResolvedValue(undefined),
  listTarefasSetor: vi.fn().mockResolvedValue([]),
  createTarefaSetor: vi.fn().mockResolvedValue(1),
  updateTarefaSetor: vi.fn().mockResolvedValue(undefined),
  deleteTarefaSetor: vi.fn().mockResolvedValue(undefined),
  listAcoesBeneficios: vi.fn().mockResolvedValue([]),
  createAcaoBeneficio: vi.fn().mockResolvedValue(1),
  updateAcaoBeneficio: vi.fn().mockResolvedValue(undefined),
  deleteAcaoBeneficio: vi.fn().mockResolvedValue(undefined),
  listAtestadosLicencas: vi.fn().mockResolvedValue([]),
  createAtestadoLicenca: vi.fn().mockResolvedValue(1),
  updateAtestadoLicenca: vi.fn().mockResolvedValue(undefined),
  listPlanosCarreira: vi.fn().mockResolvedValue([]),
  createPlanoCarreira: vi.fn().mockResolvedValue(1),
  updatePlanoCarreira: vi.fn().mockResolvedValue(undefined),
  deletePlanoCarreira: vi.fn().mockResolvedValue(undefined),
}));
