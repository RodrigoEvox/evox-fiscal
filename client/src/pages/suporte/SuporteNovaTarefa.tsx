...
export default function SuporteNovaTarefa() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <h1 className="text-2xl font-bold text-foreground">Nova Tarefa — Encaminhamento para Setor</h1>
        <p className="text-sm text-muted-foreground mt-1">
          Crie uma tarefa para encaminhar demandas a outros setores da empresa
        </p>
      </div>
